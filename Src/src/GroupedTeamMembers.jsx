...
const GroupedTeamMembers = ({ employees, selectedTeam, setTeam }) => {
  ...
  function groupTeamMembers() {
    ...
    return teams;
    // Here teams is an array of objects which contains teammembers which in itself is a modified array of selectedTeam===Team
  }
    ...
    <main className="container">
      {
        groupedEmployees.map((item) => {
          // here item is each object in the array of groupedEmployees
          return (
